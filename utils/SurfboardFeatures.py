...
def Get_feature_vectors(new_audio_path, coswara_audio_path, audio_path, load=True):
  """
  ...
  if load:
    if audio_path == new_audio_path:
      test_data_vec = np.load('/content/gdrive/MyDrive/DSCI400/Saved_Variables/Test_Vector_NewDataset.npy') # JUST LOAD THE VECTORS
      train_data_vec = np.load('/content/gdrive/MyDrive/DSCI400/Saved_Variables/Train_Vector_NewDataset.npy')
      val_data_vec = np.load('/content/gdrive/MyDrive/DSCI400/Saved_Variables/Val_Vector_NewDataset.npy')
    elif audio_path == coswara_audio_path:
      test_data_vec = np.load('/content/gdrive/MyDrive/DSCI400/Saved_Variables/Test_Vector_Coswara.npy') # JUST LOAD THE VECTORS
      train_data_vec = np.load('/content/gdrive/MyDrive/DSCI400/Saved_Variables/Train_Vector_Coswara.npy')
      val_data_vec = np.load('/content/gdrive/MyDrive/DSCI400/Saved_Variables/Val_Vector_Coswara.npy')
    ...
    if audio_path == new_audio_path:
      np.save('/content/gdrive/MyDrive/DSCI400/Saved_Variables/Test_Vector_NewDataset', test_data_vec)
      np.save('/content/gdrive/MyDrive/DSCI400/Saved_Variables/Train_Vector_NewDataset', train_data_vec)
      np.save('/content/gdrive/MyDrive/DSCI400/Saved_Variables/Val_Vector_NewDataset', val_data_vec)
    elif audio_path == coswara_audio_path:
      np.save('/content/gdrive/MyDrive/DSCI400/Saved_Variables/Test_Vector_Coswara', test_data_vec)
      np.save('/content/gdrive/MyDrive/DSCI400/Saved_Variables/Train_Vector_Coswara', train_data_vec)
      np.save('/content/gdrive/MyDrive/DSCI400/Saved_Variables/Val_Vector_Coswara', val_data_vec)
